            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
              <ScrollReveal>
                <span
                  aria-hidden
                  className={cn(
                    "pointer-events-none absolute left-0 -top-8 lg:-top-14 select-none text-[clamp(100px,14vw,180px)] font-bold leading-none text-[#0c1029]/10",
              ...
              <ScrollReveal className="shadow-md rounded-3xl" delay={0.1}>
                {Info && <Info />}
              </ScrollReveal>
            </div>
          </SectionWrapper>
